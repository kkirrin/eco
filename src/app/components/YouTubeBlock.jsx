    ...
    return(
        <section className={`${styles.youtubeContainers}`}>
            ...
            <div className={`${styles.buttonToYouTube}`}>
                <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 67 67" fill="none">
                ...
                <a href = "httpss://www.youtube.com/results?search_query=%D0%BC%D0%BE%D1%82%D0%BE%D1%86%D0%B8%D0%BA%D0%BB%D1%8B" target="_blank">
                    <h4>На канал</h4>
