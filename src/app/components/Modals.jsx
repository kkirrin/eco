...
const Modals = ({}) => {
    ...
    return(
        <section
            ...
            className = {`${styles.modalsContainer} ${(main.showModal) ? styles.avtiveModal : styles.nonAvtiveModal}`}>
            <div className={`${styles.centerMobalBlock}`} >
                ...
                >X</h3>
                {
                    (main.typeModal == "modals_auth") ? <Forms place = {"modals_auth"} /> : <Forms place = {"callback"} />
                }
            </div>
        </section>
    )
