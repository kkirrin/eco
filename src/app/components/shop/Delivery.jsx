                                ...
                                <h3 className = {`${styles.orderTitle}`}>{item.title}</h3>
                                {
                                    (item.type === 'checkbox') ? 
                                        item.variants.map((variant, index) => {
                                            return(
                                                <div  key = {`secondCheckBoxRefsKeys_${index}`} className = {`${styles.orderRow}`} key = {item.type + index}>
                                                    <input type = {item.type} name = {item.name} value = {variant} />  <span>{variant}</span>            
                                                </div>
                                            )
                                        })
                                                               : null
